...
const DIRECTIONS = [{
  n: "01",
  h: "S'entraîner",
  ex: "Sortie hebdo, séances piste, cohortes par niveau. La meute pousse."
}, {
  n: "02",
  h: "Partager",
  ex: "Récits, retours matos, échange de plans nutrition. Carnet collectif."
}, {
  n: "03",
  h: "Progresser",
  ex: "Pas de coach, pas de programme. La régularité, c'est s'entraîner en s'amusant — courir ensemble, souvent, et avancer sans y penser."
}, {
  n: "04",
  h: "Défendre",
  ex: "Refuges, sentiers, montagne. Ce qu'on traverse, on en prend soin."
}];
...
const T2T_INCLUDES = [{
  k: "Tous niveaux",
  v: "Rando, 10 km, 25 km ou grand raid — un format pour chaque paire de jambes."
}, {
  k: "Un vrai lieu",
  v: "Un refuge de montagne privatisé, loin des dossards et des barrières Vauban."
}, {
  k: "Repas & DJ set",
  v: "On mange ensemble, on danse ensemble. La soirée fait partie de la course."
}, {
  k: "Testing terrain",
  v: "On teste le matos et la nutrition en conditions réelles, entre coureurs."
}];
...
const MERCANTOUR = {
  ...
  levels: [{
    badge: "●●●",
    name: "Engagé",
    sub: "Haute montagne · confirmé",
    items: [{
      name: "Le Tour de la Vallée des Merveilles",
      km: "19 km",
      dplus: "≈ 1 550 D+ · pointe à 2 699 m",
      tag: "Plus sportif · confirmé",
      gpx: "gpx/tour-vallee-des-merveilles.gpx",
      ...
      name: "Le Clapier",
      km: "16,5 km",
      dplus: "≈ 1 550 D+ · sommet à 3 039 m",
      tag: "Boucle sommet · engagé",
      gpx: "gpx/le-clapier.gpx",
    ...
    badge: "●●○",
    name: "Sportif",
    sub: "Ça grimpe, mais ça se partage",
    items: [{
      name: "Le Balcon du Gelas",
      km: "≈ 14 km A/R",
      dplus: "≈ 1 330 D+ · jusqu'à 2 933 m",
      tag: "Raide et panoramique",
      gpx: "gpx/balcon-du-gelas.gpx",
      ...
      name: "La Jonction",
      km: "≈ 10 km A/R",
      dplus: "≈ 560 D+ · refuge de Nice (2 232 m)",
      tag: "La montée au refuge de Nice",
      gpx: "gpx/la-jonction.gpx",
    ...
    badge: "●○○",
    name: "Tranquille",
    sub: "Zéro chrono, zéro pression",
    items: [{
      name: "La Rando",
      km: "Allure libre",
      dplus: "à la carte",
      tag: "Sans chrono · contemplatif",
      foot: "Ouvert à tous",
      img: "img/rando.jpeg"
    }, {
      name: "Le Chill Max",
      km: "Refuge only",
      dplus: "0 D+",
      tag: "Zéro course · juste la vibe",
      foot: "C'est cadeau",
      img: "img/chillmax.jpg"
    }]
  }],
  program: [{
    day: "Jeudi soir",
    ...
    items: [{
      t: "18:00",
      h: "Event de départ · Port de Nice",
      s: "Toute la commu envoie la team expé",
      kind: "night"
    }, {
      t: "18:27",
      h: "Départ de l'expédition",
      s: "Cap sur les 3 143 m — la grande traversée commence",
      kind: "trail"
    }]
  }, {
    day: "Vendredi",
    ...
    items: [{
      t: "Journée",
      h: "On suit la team en direct",
      s: "Canal WhatsApp « Partage ta sortie » — photos, points GPS, moral",
      kind: "trail"
    }, {
      t: "En montée",
      h: "Cols, crêtes, refuges",
      s: "La team avale le dénivelé vers le Relais des Merveilles",
      kind: "trail"
    }]
  }, {
    day: "Samedi",
    date: "8 août · Relais des Merveilles",
    phase: "peak",
    items: [{
      t: "09:00",
      h: "Boucles commu au départ du Relais",
      s: "Merveilles · Clapier · Balcon · Jonction · rando — chacun son format",
      kind: "trail"
    }, {
      t: "15:00",
      h: "Arrivée de la team expé au Relais",
      s: "On monte les accueillir au refuge de Nice par la Jonction",
      kind: "trail"
    }, {
      t: "19:30",
      h: "Repas de refuge",
      s: "Relais des Merveilles · produits du coin",
      kind: "night"
    }, {
      t: "22:00",
      h: "DJ set",
      s: "La piste s'ouvre sous les étoiles",
      kind: "night"
    }]
  }, {
    day: "Dimanche",
    date: "9 août · Lac Autier",
    phase: "day",
    items: [{
      t: "10:00",
      h: "Testing Näak · Lac Autier",
      s: "Montée tranquille jusqu'au lac, sans chrono",
      kind: "trail"
    }, {
      t: "14:00",
      h: "Sunset closing",
      s: "Dernier café, on se dit à l'an prochain",
      kind: "night"
    }]
  }],
  options: [{
    k: "Repas d'après course",
    v: "Brunch & pique-nique servis au Relais des Merveilles au retour du sommet.",
    img: "img/terrace.jpg"
  }, {
    k: "Nuit en refuge",
    v: "Couchage au Relais des Merveilles, dîner et petit-déj montagne inclus.",
    img: "img/chalet.jpg"
  }],
  ...
  commu: {
    saturday: [{
      name: "Le 10K",
      km: "≈ 10 km",
      tag: "Boucle découverte",
      ex: "Une boucle accessible autour du refuge pour venir vivre le week-end sans gros volume.",
      soon: true
    }, {
      name: "Le 25K",
      km: "≈ 25 km",
      tag: "Plus sportif",
      ex: "Un tracé plus engagé sur les sentiers de la Vallée des Merveilles pour les jambes affûtées.",
      soon: true
    }, {
      name: "La Rando",
      km: "Allure libre",
      tag: "Sans chrono",
      ex: "Montée contemplative jusqu'au refuge, à son rythme. Sur les traces de Belle et Sébastien et des routes du Sel, zéro pression.",
      soon: true
    }, {
      name: "Rejoindre l'expé",
      km: "Relais → refuge",
      tag: "Aller à leur rencontre",
      ex: "Départ du Relais des Merveilles, montée jusqu'au refuge de Nice pour accueillir la team expédition et redescendre avec elle. La montagne à plusieurs.",
      soon: false
    }],
    sunday: {
  ...
  pricing: {
    formulas: [{
      name: "Camping",
      price: "80",
      sub: "Plus que 20 places · esprit bivouac"
    }, {
      name: "Dortoir",
      price: "105",
      sub: "Plus que 15 places · l'esprit refuge",
      featured: true,
      badge: "Le QG de la meute"
    }, {
      name: "Chambre 4 pers",
      price: "125",
      sub: "Plus que 2 chambres !"
    }, {
      name: "Chambre double",
      price: "135",
      sub: "Victime de son succès",
      soldout: true
    }],
    included: ["Accès aux traces du samedi : 10 km, 25 km, rando détente ou chill", "Apéro cocktail : pissaladière, tapenade, guacamole", "Grand buffet : entrée, plat, fromages, dessert, café — vin compris (1 bouteille pour 6)", "Set techno & ambiance TTC jusqu'au bout de la nuit", "Literie fournie : draps, oreillers, taies et couvertures", "Dimanche : petit-déj léger (boisson chaude + tartines) + testing Näak"],
    options: ["+31 € · Brunch du dimanche au Relais", "+13 € · Pique-nique après le testing Näak"],
    ...
    partners: [{
      name: "Näak",
      tag: "Nutrition officielle",
      url: "https://www.naak.com/fr",
      ex: "Barres, gels et purées d'effort à tester avant, pendant et après les traces. L'espace testing tourne tout le week-end."
    }, {
      name: "Wise",
      tag: "Wise Trail Running · équipement",
      url: "https://wiseultrarunning.com/collections/all",
      ex: "Du matos d'ultra-trail pensé pour les longues heures en montagne — à découvrir et tester sur le week-end."
    }, {
      name: "Go'Lum",
      tag: "Frontales · éclairage",
      url: "https://www.go-lum.fr/",
      ex: "Des frontales taillées pour la nuit en montagne. Parfait quand la journée se prolonge jusqu'au dancefloor."
    }],
...
const RACLETTE = {
  ...
  teams: [{
    ...
    name: "Team Expé",
    tag: "La traversée",
    ex: "45 km et +3 589 m jusqu'au Chalet Albarea. Neige, pluie, brouillard — et le sourire quand même."
  }, {
    n: "02",
    name: "Team Vélo",
    tag: "À la pédale",
    ex: "Montée au chalet à vélo par Peira Cava. Une autre manière de mériter la raclette."
  }, {
    n: "03",
    name: "Team Demi",
    tag: "La moitié",
    ex: "Départ à mi-parcours pour rejoindre la team expé en route et finir ensemble."
  }, {
    n: "04",
    name: "Team Boucle",
    tag: "Au départ du chalet",
    ex: "Une boucle tranquille autour d'Albarea, retour au chaud pour le fromage."
  }],
  playlist: "5HeKXzdlrErvXZaaOYmfEG",
  gallery: [{
    img: "img/rac-climb.jpg",
    cap: "Team expé · poudreuse au soleil"
  }, {
    img: "img/rac-silhouette.jpg",
    cap: "Sous les sapins chargés"
  }, {
    img: "img/rac-rain.jpg",
    cap: "Regroupement · neige & pluie"
  }, {
    img: "img/rac-party.jpg",
    cap: "Raclette au chalet · le t-shirt de l'édition"
  }]
};
...
const MONTCHAUVE = {
  ...
  links: [{
    label: "Le DJ set",
    sub: "sur YouTube",
    href: "https://youtu.be/pMIHIoRCogg?si=aSy-CzkZ7_ZBsezJ"
  }, {
    label: "Le clip",
    sub: "sur YouTube",
    href: "https://youtu.be/gl_mZ91vhmU?si=5Q35Az1ubI89mGrZ"
  }],
  playlist: "3vyfirO02s0EqrN3fC7amY",
  gallery: [{
    img: "img/mc-run.jpg",
    cap: "Départ · Promenade des Anglais"
  }, {
    img: "img/mc-summit.jpg",
    cap: "Cap sur le Mont Chauve"
  }, {
    img: "img/mc-smoke.jpg",
    cap: "Fumigènes au sommet"
  }, {
    img: "img/mc-banner.jpg",
    cap: "NOLT × ttc × Resonance"
  }]
};
...
const ADHESION = {
  ...
  benefits: [{
    n: "01",
    k: "Les infos en prio",
    v: "Events du club et éditions Trail to Techno annoncés en avant-première. Tu réserves ta place avant tout le monde."
  }, {
    n: "02",
    k: "Promos partenaires",
    v: "Des réductions réservées aux membres chez nos partenaires."
  }, {
    n: "03",
    k: "Réducs sur les events",
    v: "Tarif membre sur les éditions Trail to Techno et les stages."
  }, {
    n: "04",
    k: "Soirées exclusives",
    v: "Accès aux soirées réservées à la meute : DJ sets, refuges privatisés, afters."
  }, {
    n: "05",
    k: "Espace membre & outils trail",
    v: "Ton espace adhérent avec des outils trail : plans et ressources d'entraînement, suivi de tes courses et de tes stats, traces GPX du club, gestion de tes team courses et de tes inscriptions.",
    wide: true
  }],
  community: [{
    free: true,
    k: "Les runs officiels · gratuits",
    v: "Les sorties hebdo du club restent ouvertes à tout le monde, sans adhésion."
  }, {
    free: true,
    k: "La commu en ligne · gratuite",
    v: "On y cale les sorties, on partage les traces et on annonce les events."
  }, {
    free: false,
    k: "Des ressources pour progresser",
    v: "Plans, conseils d'entraînement et retours d'expé réservés aux membres."
  }, {
    free: false,
    k: "Des events liés au trail",
    v: "Stages, sorties longues et rendez-vous trail exclusifs aux adhérents."
  }],
  ...
  levels: [{
    em: "🌱",
    name: "Débutant",
    desc: "Découverte, premières sorties."
  }, {
    em: "🏃",
    name: "Intermédiaire",
    desc: "Quelques sorties et courses au compteur."
  }, {
    em: "🔥",
    name: "Confirmé",
    desc: "Trails réguliers, ça pousse fort."
  }, {
    em: "🏔️",
    name: "Ultra",
    desc: "Longues distances, terrain engagé."
  }],
  stylesLevels: [{
    em: "🎧",
    name: "Curieux",
    desc: "Là pour la vibe et l'ambiance."
  }, {
    em: "🔊",
    name: "Amateur",
    desc: "Le dancefloor commence à t'appeler."
  }, {
    em: "🕺",
    name: "Teufeur",
    desc: "Dernier carré, toujours partant."
  }, {
    em: "👑",
    name: "Résident",
    desc: "Tu fermes la piste au lever du soleil."
  }],
  ...
  formules: [{
    ...
    features: ["Montant libre, ponctuel ou régulier", "Tu finances directement les events et le matos du club", "Un grand merci de toute la meute 🙏"]
  }, {
    key: "adherent",
    name: "Adhérent",
    tag: "Le plus complet",
    ...
    features: ["Welcome pack aux couleurs du TTC (t-shirt + goodies)", "Espace adhérent avec ses outils trail (plans, suivi, traces GPX)", "Priorité d'inscription aux weekends & events", "Tarifs avantageux sur les events signatures & le merch", "Codes & réductions chez nos partenaires", "Accès aux soirées réservées à la meute"]
  }, {
    key: "licence",
    ...
    features: ["Tout ce que comprend Adhérent", "Licence FFA Running (loisir + assurance) ou Compétition", "Pour courir les courses officielles sous les couleurs TTC"]
  }]
};
