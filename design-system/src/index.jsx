// Tout Terrain Club — design system components.
// Ported verbatim from the site's atoms.jsx into ES modules (React imported,
// components exported). Behaviour is identical to the shipped site code — this
// is the source of truth the design-sync bundle is compiled from.
import React from "react";

/** Pictogramme montagne TTC (SVG monochrome, hérite de currentColor). */
export const TtcLogo = ({ size = 28 }) => (
...
export const HeaderPublic = ({ active = "Accueil" }) => {
  const items = [
...
/** Bandeau promo défilant (édition en cours, ville, saison). */
export const PromoStrip = () => (
  <div className="promo-strip">
    <span><span className="dot">●</span> Trail to Techno · Édition Mercantour · 8–9 août 2026 · Vallée de la Gordolasque</span>
...
/** Mini-graphe de dénivelé (aire hachurée + tracé), couleurs paramétrables. */
export const ElevSparkline = ({ stroke = "var(--ink)", fill = "var(--green-soft)" }) => (
...
/** Carte topographique de substitution avec tracé de parcours (départ → sommet). */
...
/** Annotation manuscrite « → logo + meute » avec flèche (accent éditorial). */
...
/** Bandeau partenaires (grille de cartes cliquables). */
...
/** Pied de page public : marque, réseaux, liens club, mentions. */
